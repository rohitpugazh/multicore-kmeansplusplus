...
if __name__ == "__main__":
    ...
    if args.file:
        clumpy = CLUMPY(k=k, file=args.file, delimiter=args.delimiter, random_centroids=random_centroids, processes=processes)
    else:
        clumpy = CLUMPY(k=k, n=args.n, d=args.d, max_value=args.max_value, deviation=args.deviation, delimiter=args.delimiter, iterations=args.iterations, random_centroids=random_centroids, processes=processes)
